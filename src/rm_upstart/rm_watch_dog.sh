...
NODE_NAMES=("gimbal_manager" "rm_serial_ext")  # 列出所有需要监控的节点名称，注意是用空格分隔
USER="$(whoami)" #用户名
HOME_DIR=$(eval echo ~$USER)
WORKING_DIR="$HOME_DIR/Downloads/pb2025_infantry_ws" # 代码目录
LAUNCH_FILE="pb2025_infantry_bringup cuhk_bringup.launch.py" # launch 文件
