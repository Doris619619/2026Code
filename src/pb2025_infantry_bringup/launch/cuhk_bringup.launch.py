...
def generate_launch_description():
    ...
    serial_bringup_dir = get_package_share_directory("rm_serial")
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(bringup_dir, "rviz", "infantry_default_view.rviz"),
    ...
    start_serial_driver_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                serial_bringup_dir, "launch", "serial_driver.launch.py"
            )
        ),
